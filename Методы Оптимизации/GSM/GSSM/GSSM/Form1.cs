...
namespace GSSM
{
    public partial class Form1 : Form
    {
        ...
        private void Solve_button_Click(object sender, EventArgs e)
        {
            ...
            else
            {
                try
                {
                    ...
                    GoldenSearch method = new GoldenSearch();
                    x = method.FindOptimum(Function_ComboBox, A_TextBox, b_textbox, Tolerance_TextBox, MAXIteration_TextBox, MAXTime_TextBox, PB_ProgressBar);
                    ...
                    ABS_TextBox.Text = string.Format("{0:0.##e+00}", method.tol_res);
        ...
        private void b_textbox_KeyPress(object sender, KeyPressEventArgs e)
        {
            if ((e.KeyChar >= '0') && (e.KeyChar <= '9'))
            {
                return;
