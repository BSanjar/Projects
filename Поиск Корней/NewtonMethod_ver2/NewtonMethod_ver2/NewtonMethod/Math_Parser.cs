    ...
    public class MathParser
    {
        ...
        public MathParser(bool loadPreDefinedFunctions = true, bool loadPreDefinedOperators = true, bool loadPreDefinedVariables = true)
        {
            ...
            if (loadPreDefinedFunctions)
            {
                ...
                LocalFunctions.Add("lg", delegate (decimal[] input)
                {
                    // input[0] is the number
                    // input[1] is the base
                    ...
                    {
                        case 1:
                            return (decimal)Math.Log((double)input[0],10);
                        case 2:
                            return (decimal)Math.Log((double)input[0], (double)input[1]);
                        default:
                            return 0; // false
        ...
        {
           decimal p=MathParserLogic(Scanner(mathExpression));
            return p;
        }
        ...
        {
            decimal per= MathParserLogic(new List<string>(mathExpression));
            return per;
        }
